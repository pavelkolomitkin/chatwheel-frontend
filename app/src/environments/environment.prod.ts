export const environment = {
  ...
  nearGeoCoordinateMaxDelta: 0.0005,
  ...
  fbAuthorizationLink:
    'https://www.facebook.com/v13.0/dialog/oauth?client_id=1011395893066866&redirect_uri=https://www.chatwheel.ru/security/social-auth/fb&state=fbChatWheel&response_type=code%20token&scope=public_profile',
  vkAuthorizationLink:
    'https://oauth.vk.com/authorize?client_id=8097405&redirect_uri=https://www.chatwheel.ru/security/social-auth/vk&scope=offline,photos&display=page&response_type=token',
