...
docker container run --rm -it --name frontend-dev -p 4200:4200 --user $CURRENT_USER_ID:$CURRENT_USER_GROUP_ID -v $(pwd)/../../app:/app -w /app teracy/angular-cli@sha256:228e00d4f6ba80db7c26ee05f73498bf688e624b85ca8cba71d2f362c3005c2e /bin/bash
